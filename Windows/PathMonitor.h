...
public:
   ...
   CPathMonitor()
      : m_hThread(NULL), m_hEvent(NULL), m_hWnd(NULL),
        ...
        m_dwDelay(0L)
   {
      m_uPathChangedMessage = ::RegisterWindowMessage(TEXT("PathMonitor_PathChangedMessage"));
   ...
   BOOL Install(HWND hWnd, LPCTSTR pszPath)
   {
      ...
      DWORD dwThreadID;
#if !defined(_ATL_MIN_CRT) & defined(_MT)
      m_hThread = (HANDLE)_beginthreadex(NULL, 0, (UINT (WINAPI*)(void*))MonitorProc, this, 0, (UINT*)&dwThreadID);
#else
