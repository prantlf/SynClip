...
class CSettings
{
    ...
    BOOL Load() {
        ...
        m_bSychronizingEnabled = ini.GetBoolean( TEXT( "Default" ),
                                 TEXT( "SychronizingEnabled" ), TRUE );
        m_bNotifyOnClipboardChange = ini.GetBoolean( TEXT( "Default" ),
                                     TEXT( "NotifyOnClipboardChange" ), TRUE );
        return TRUE;
    }
...
public:
    ...
    BOOL Save() {
        CIni ini( m_strFilePath );
        ini.WriteString( TEXT( "Default" ), TEXT( "ClipboardFile" ),
                         m_strClipboardFile );
        ini.WriteBoolean( TEXT( "Default" ), TEXT( "SychronizingEnabled" ),
                          m_bSychronizingEnabled );
        ini.WriteBoolean( TEXT( "Default" ), TEXT( "NotifyOnClipboardChange" ),
                          m_bNotifyOnClipboardChange );
        return TRUE;
    }
